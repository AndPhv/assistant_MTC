...
class LessonVM: ViewModel() {
    private val lessonList = arrayListOf(
        LessonDomain("1", "Лекция в аудитории 101","Тактика ВВС", "Непорожнев Д.А.","Тактика военно-воздушных сил — составная часть военного искусства ВВС, включающая теорию и практику подготовки и ведения боя авиационным соединением, частью, подразделением, одиночным самолётом (вертолётом). ")
    )
